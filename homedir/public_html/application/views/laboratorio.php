...
?>
<div class="banner">
    <img src="assets/images/banner/laboratorio.jpg" style="width:100%;"/>
</div>
<div class="container-inst0 container-laboratorio">
    <div class="container-inst">
        <div class="left">
            <?=$conteudo['content'];?>
        </div>
        <div class="right">
            <iframe width="500" height="281" src="https://www.youtube.com/embed/tmvOgtVH5ds" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
