...
<body>
    <div class="container" style="text-align: justify;">
 	...
 	.text-center {
		...
		<p class="parag"><b>Parágrafo Primeiro</b> - Os serviços objeto do presente contrato e que serão prestados direta e exclusivamente pela CONTRATADA, e/ou por sua rede credenciada, ao CONTRATANTE, conforme adiante especificado:</p>
		<br />

		<h4><u>TIPO DE PLANO: MÚTUO</u></h4>
		<p>a) ATENDIMENTO FUNERÁRIO<br />
            Urna mortuária de madeira envernizada (alça tipo parreira sextavada sem visor) tamanho padrão; ornamentação da urna, com edredom de cetim e/ou flores naturais disponíveis na ocasião; montagem de paramentos (Essa) de acordo com o credo religioso; carro para cortejo fúnebre dentro do Município; preparação do corpo (vestir e colocar na urna); providências administrativas para obtenção de Laudo Médico nessa localidade; um livro para registro de presença; um véu; velas votivas; dois vasos de flores; publicação do óbito por uma rádio local; publicação do óbito por um jornal local; sala para velório e serviço de copa com água, café, chá e bolacha nas cidades onde a CONTRATADA possuir sede instalada.
        <p>
		<br />

		<p>b) TRASLADO<br />
		1) Traslado, até 50 (cinquenta) quilômetros percorridos, compreendendo ida e volta, exclusivamente por via terrestre, quando o (a) CONTRATANTE ou seus BENEFICIÁRIOS residirem ou falecerem em outra localidade e optarem pelo sepultamento na cidade sede da CONTRATADA. Ultrapassando o limite referido, será cobrada uma taxa por quilômetro rodado, cujo valor será o mesmo indicado na tabela oficial do SEFESP (Sindicato das Empresas Funerárias do Estado de São Paulo), ou na falta desta, a indicada pela CONTRATADA.</p>
		<br />
		...
		3) Havendo necessidade de urna de tamanho especial convencionadas como “Urna Gorda” ou “Urna Alta”, ou interesse de qualquer forma por modelo diferente da prevista neste contrato a diferença de preço será suportada exclusivamente pelo CONTRATANTE, podendo porém valer-se normalmente dos demais serviços oferecidos.<br />
		...
		<p class="parag"><b>Parágrafo Primeiro</b> – Serão considerados beneficiários do CONTRATANTE aqueles que tenham comprovada a relação de parentesco ou afinidade, e estejam devida e obrigatoriamente identificados na <b>Ficha de Cadastro de Beneficiários</b>, parte integrante deste, limitados a no máximo 10 (dez) pessoas.
        </p>
		...
		<p class="parag"><b>Parágrafo Primeiro</b> - A carência para atendimento ao CONTRATANTE e seus beneficiários será de 90 (noventa) dias contados da assinatura do presente contrato; e no caso dos beneficiários inclusos posteriormente de 120 (cento e vinte dias) da data de sua inclusão no plano.</p>
		<p class="parag"><b>Parágrafo Segundo</b> - A carência que trata o PARÁGRAFO ANTERIOR não se aplicará ao (à) CONTRATANTE e seus beneficiários que já tenha outro Contrato Funerário firmado com outra empresa e tenham cumprido o período de carência e optar por este PLANO FUNERÁRIO.</p>
		<br />
		...
		<p class="parag"><b>Parágrafo Primeiro</b> - Como contraprestação pelos serviços contratados, o CONTRATANTE pagará à CONTRATADA o valor de R$ 1.440,00 (Um mil quatrocentos e quarenta reais), através de 48 (quarenta e oito) parcelas mensais de R$ 30,00 (trinta reais) com vencimento no mês seguinte ao mês vencido, representando cada parcela o pagamento da assistência prestada no mês da quitação.</p>
		...
		<p class="parag"><b>Parágrafo Terceiro</b> - O valor contratado sofrerá reajuste anual, no mês de Maio, mediante aplicação do Índice Geral de Preços do Mercado (IGPM/FGV), na falta deste pela variação dos valores dos custos e insumos ou índices governamentais permitidos</p>
		...
		<p class="parag"><b>Parágrafo Único</b> - A taxa de Adesão para o PLANO FUNERÁRIO MÚTUO será de R$ 100,00 (cem reais), que deverá ser paga no momento da assinatura do presente contrato.</p>
		<br />
		...
		<p class="parag"><b>Parágrafo Primeiro</b> - No caso do falecimento do CONTRATANTE, seus beneficiários poderão sucedê-lo na contratação, observado o pagamento de mensalidades, período de contratação e carências, além das demais cláusulas e condições contratuais anteriormente assumidas pelo CONTRATANTE.</p>
		<br />

		<h4><u>CLÁUSULA DÉCIMA SEXTA - DAS DISPOSIÇÕES FINAIS</u></h4>
		<p class="parag"><b>Parágrafo primeiro</b> - O CONTRATANTE declara estar ciente de que, à exceção da hipótese prevista na cláusula décima-quarta, em nenhuma outra situação lhe serão devolvidos valores pagos por força do presente contrato.</p>
		...
		<p class="parag"><b>Parágrafo terceiro</b> - O CONTRATANTE é responsável pela veracidade das informações prestadas no presente contrato, bem como no Termo de Adesão anexo, seja por si seja por seus beneficiários, que assim ficam cientes e solidários às condições contratadas, obrigando-se a manter atualizado, junto à CONTRATADA, suas informações cadastrais, especialmente endereços, físico e eletrônico, e telefone.</p>
		...
		<p class="parag"><b>Parágrafo Único</b> - Fica eleito o foro da Comarca de Descalvado, Estado de São Paulo, renunciando-se a qualquer outro, por mais privilegiado que seja, para dirimir suas duvidas ou interpretações, bem como sua execução.<br />E, por estarem assim acordes, as partes firmam o presente em 02 (duas) vias, de idêntico teor, na presença de 02 (duas) testemunhas, que também firmam o presente.</p>
		<br /><br />
