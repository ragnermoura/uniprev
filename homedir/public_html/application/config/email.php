...
$config['mail_from']        = 'webmaster@uniprev.com.br';
$config['mail_name']        = 'Uniprev - ';
$config['mail_to']        	= 'descalvado@uniprev.com.br';
//$config['mail_to']        	= 'rafaelmarrichi@gmail.com';

$config['useragent']        = 'PHPMailer';              // Mail engine switcher: 'CodeIgniter' or 'PHPMailer'
$config['protocol']         = 'smtp';                   // 'mail', 'sendmail', or 'smtp'
$config['mailpath']         = '/usr/sbin/sendmail';
$config['smtp_host']        = 'mail.uniprev.com.br';
$config['smtp_user']        = 'webmaster@uniprev.com.br';
$config['smtp_pass']        = '0010101a';
