...
?>
<div class="banner">
    <img src="assets/images/banner/funeraria.jpg" style="width:100%;"/>
</div>
<div class="container-inst0 container-funeraria">
    <div class="container-inst">
        <div class="left">
            <?=$conteudo['content'];?>
        </div>
        <div class="right">
            <iframe width="500" height="281" src="https://www.youtube.com/embed/CUOf411CtaQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
