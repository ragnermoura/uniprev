...
?>
<div class="banner">
    <img src="assets/images/banner/casa.jpg" style="width:100%;"/>
</div>
<div class="container-inst0 container-uni-casa">
    <div class="container-inst">
        <div class="left">
            <?=$conteudo['content'];?>
        </div>
        <div class="right">
            <iframe width="500" height="281" src="https://www.youtube.com/embed/o0BTG1sUxZc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <img src="assets/images/vantagens/casa.jpg" />
        </div>
        <br class="clear" />
    </div>
    <div class="inst-est0">
