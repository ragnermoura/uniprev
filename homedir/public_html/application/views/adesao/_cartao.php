    ...
    <div class="container-inst">
        <div class="row">
            <div class="col-md-12 text-center">
                <a href="<?php echo site_url('adesao/pagamento/boleto/' . $this->funcoes->encode($ficha['id'])); ?>"><h4>Clique aqui para pagar com <i class="fa fa-barcode" aria-hidden="true"></i> Boleto</h4></a>
                <hr />
                <br />
            </div>
        </div>
        ...
        if(creditCardHolderName.length <= 0 || creditCardHolderCPF.length <= 0 || creditCardHolderBirthDate.length <= 0 || creditCardHolderPhone.length <= 0) {
            ...
            PagSeguroDirectPayment.createCardToken({
                ...
                success: function(data) {
                    console.log('sucesso');
                    $.ajax({
                        url: '<?php echo site_url('adesao/cartao_transition'); ?>',
